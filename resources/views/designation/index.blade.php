...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-4">Designations</h1>
        ...
        <div class="col-lg-12">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Designations | List</h6>
                </div>
                ...
                <div class="card-body">
                    <div class="table-list">
                        <div class="table-responsive">
                            <table class="table table-bordered" id="designation_table" width="100%" cellspacing="0">
                                <thead>
                                    <tr>
                                        <th>SL No</th>
                                        <th>Name</th>
...
<div class="modal fade" id="myModal">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form id="designation_form" method="post" action="#">
                <div class="modal-body">
                    <div class="form-group row">
                        <label class="col-xl-4">Designation Name <i class="asterisk">*</i> </label>
                        <div class="col-xl-8">
...
@section('scripts')
    <script>
        let tableURL = "{{ route('designations') }}";
        let saveURL = "{{ route('saveDesignation') }}";
        let getURL = "{{ route('getDesignation') }}"; 
        let deleteURL = "{{ route('deleteDesignation') }}";
    </script>
